import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, computed, withAsyncContext, mergeProps, unref, withCtx, createVNode, toDisplayString, createTextVNode, toRaw, resolveComponent, defineAsyncComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderAttr, ssrRenderSlot } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/vue/server-renderer/index.mjs';
import { pascalCase, kebabCase } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/scule/dist/index.mjs';
import destr from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/destr/dist/index.mjs';
import { find, html } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/property-information/index.js';
import { toHast } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/minimark/dist/hast.mjs';
import { e as useRoute, u as useAsyncData, a as useHead, _ as __nuxt_component_0$1, f as useRuntimeConfig } from './server.mjs';
import { CalendarDays } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/lucide-vue-next/dist/cjs/lucide-vue-next.js';
import { q as queryCollection } from './client-D95BkcE1.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/ofetch/dist/node.mjs';
import '../_/nitro.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/h3/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/ufo/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/hookable/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/node-mock-http/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/klona/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/defu/dist/defu.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/radix3/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/vue-router/vue-router.node.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/unstorage/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/unstorage/drivers/fs.mjs';
import 'file:///C:/Users/j1829/Desktop/blog-nuxt4/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/unstorage/drivers/fs-lite.mjs';
import 'node:fs';
import 'node:url';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/pathe/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/ipx/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/ohash/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/nuxt/node_modules/hookable/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/unctx/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/perfect-debounce/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/@vue/shared/dist/shared.cjs.prod.js';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/vue-devtools-stub/dist/index.mjs';
import '../_/renderer.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/unhead/dist/server.mjs';
import 'node:async_hooks';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/devalue/index.js';
import 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/unhead/dist/utils.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: articleList } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
    ...
    const { data: allData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "all-articles-nav",
      () => queryCollection("content").all()
    )), __temp = await __temp, __restore(), __temp);
    const allArticles = computed(() => {
      if (!allData.value) return [];
      return [...allData.value].filter((a) => a.meta?.date).sort((a, b) => (b.meta?.date || "").localeCompare(a.meta?.date || ""));
    });
    const prevArticle = computed(() => {
      if (!allArticles.value) return null;
      const idx = allArticles.value.findIndex((a) => a.path === targetPath.value);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "pt-24 pb-12 px-4 sm:px-6 relative z-10" }, _attrs))}>`);
      if (unref(article)) {
        _push(`<div class="article-wrapper max-w-4xl mx-auto bg-white dark:bg-slate-800 p-8 shadow-sm rounded-2xl transition-colors"><header class="mb-8 border-b border-slate-100 dark:border-slate-700 pb-8"><h1 class="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4">${ssrInterpolate(unref(article).title || unref(article).meta?.title)}</h1>`);
        if (unref(article).meta?.date) {
          _push(`<div class="flex items-center text-slate-500 dark:text-slate-400 text-sm">`);
          _push(ssrRenderComponent(unref(CalendarDays), { class: "w-4 h-4 mr-1" }, null, _parent));
          _push(` ${ssrInterpolate(unref(article).meta.date)}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</header>`);
        if (unref(article).meta?.cover) {
          _push(`<div class="mb-8"><img${ssrRenderAttr("src", unref(article).meta.cover)}${ssrRenderAttr("alt", unref(article).title)} loading="lazy" class="w-full h-auto rounded-xl shadow-md mx-auto"></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="prose prose-blue dark:prose-invert max-w-none prose-img:rounded-xl prose-headings:text-slate-900 dark:prose-headings:text-slate-100">`);
        _push(ssrRenderComponent(_component_ContentRenderer, { value: unref(article) }, null, _parent));
        _push(`</div><div class="mt-12 pt-8 border-t border-slate-100 dark:border-slate-700 flex justify-between items-center">`);
        if (unref(prevArticle)) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/news${unref(prevArticle).path}`,
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span${_scopeId}>«</span><span class="hidden sm:inline"${_scopeId}>${ssrInterpolate(unref(prevArticle).title || unref(prevArticle).meta?.title)}</span><span class="sm:hidden"${_scopeId}>${ssrInterpolate(_ctx.$t("news.prevArticle"))}</span>`);
              } else {
                return [
                  createVNode("span", null, "«"),
                  createVNode("span", { class: "hidden sm:inline" }, toDisplayString(unref(prevArticle).title || unref(prevArticle).meta?.title), 1),
                  createVNode("span", { class: "sm:hidden" }, toDisplayString(_ctx.$t("news.prevArticle")), 1)
                ];
              }
            }),
            _: 1
          ...
          _push(`<span class="text-slate-300 dark:text-slate-600">« ${ssrInterpolate(_ctx.$t("news.noPrevArticle"))}</span>`);
        }
        if (unref(nextArticle)) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/news${unref(nextArticle).path}`,
            class: "inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="hidden sm:inline"${_scopeId}>${ssrInterpolate(unref(nextArticle).title || unref(nextArticle).meta?.title)}</span><span class="sm:hidden"${_scopeId}>${ssrInterpolate(_ctx.$t("news.nextArticle"))}</span><span${_scopeId}>»</span>`);
              } else {
                return [
                  createVNode("span", { class: "hidden sm:inline" }, toDisplayString(unref(nextArticle).title || unref(nextArticle).meta?.title), 1),
                  createVNode("span", { class: "sm:hidden" }, toDisplayString(_ctx.$t("news.nextArticle")), 1),
                  createVNode("span", null, "»")
                ];
              }
            }),
          ...
          _push(`<span class="text-slate-300 dark:text-slate-600">${ssrInterpolate(_ctx.$t("news.noNextArticle"))} »</span>`);
        }
        _push(`</div></div>`);
      } else {
        _push(`<div class="text-center py-20 bg-white dark:bg-slate-800 rounded-2xl max-w-4xl mx-auto shadow-sm"><h2 class="text-2xl font-semibold text-slate-600 dark:text-slate-400">文章未找到了 🥲</h2><p class="text-slate-400 mt-2">路径: ${ssrInterpolate(unref(targetPath))}</p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/news",
          class: "text-blue-500 mt-6 inline-block hover:underline"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`返回文章列表`);
...
//# sourceMappingURL=_...slug_-Ben7mzCy.mjs.map

import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import * as Vue from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/vue/index.mjs';
import { getCurrentScope, onScopeDispose, hasInjectionContext, inject, getCurrentInstance as getCurrentInstance$1, defineComponent, shallowRef, h, resolveComponent, computed, unref, defineAsyncComponent, createElementBlock, provide, cloneVNode, isRef, toValue, onServerPrefetch, reactive, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, mergeProps, withCtx, createTextVNode, onErrorCaptured, resolveDynamicComponent, effectScope, nextTick, toRef, isReadonly, isShallow, isReactive, toRaw, customRef } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/ofetch/dist/node.mjs';
import { i as baseURL } from '../_/nitro.mjs';
import { createHooks } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/nuxt/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/unctx/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/vue-router/vue-router.node.mjs';
import { createDefu, defu } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, withTrailingSlash, withoutTrailingSlash, parsePath, isEqual as isEqual$1 } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/ufo/dist/index.mjs';
import { debounce } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/perfect-debounce/dist/index.mjs';
import { hash, isEqual } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/ohash/dist/index.mjs';
import { isPlainObject as isPlainObject$1 } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/@vue/shared/dist/shared.cjs.prod.js';
import { klona } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/klona/dist/index.mjs';
import { parse as parse$1 } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, getRequestURL, appendHeader, getRequestHeader, getCookie, setCookie, deleteCookie } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/h3/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file://C:/Users/j1829/Desktop/blog-nuxt4/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./_...slug_-Ben7mzCy.mjs')
  },
  {
    name: "news-slug___en",
    path: "/en/news/:slug(.*)*",
  ...
  },
  {
    name: "about___zh",
    path: "/about",
    component: () => import('./about-A_Jyfr1D.mjs')
  },
  {
    name: "about___en",
    path: "/en/about",
  ...
  {
    name: "friendlink___zh",
    path: "/friendlink",
    component: () => import('./friendlink-CLQ-Dg2A.mjs')
  },
  {
    name: "friendlink___en",
    path: "/en/friendlink",
    component: () => import('./friendlink-CLQ-Dg2A.mjs')
  },
  {
    name: "news___zh",
    path: "/news",
    component: () => import('./index-DGtfd3rq.mjs')
  },
  {
    name: "news___en",
    path: "/en/news",
  ...
  },
  {
    name: "index___zh",
    path: "/",
    component: () => import('./index-B7gqJD8g.mjs')
  },
  {
    name: "index___en",
    path: "/en",
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-CUrxEcAB.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DYV9_cLM.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-BUlwT6fU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-G7Wa3Bnh.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-D-MQcqHh.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-zPDBYAQT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-LzjBr3Xd.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-2ot5LDvL.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-Cz0vgz45.mjs').then((r) => r["default"] || r.default || r));
  ...
  zh: [
    {
      ...
      load: () => import(
        './zh-DIyehTxD.mjs'
        /* webpackChunkName: "locale_zh_46json_863c812c" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-XDuzd1v7.mjs'
        /* webpackChunkName: "locale_en_46json_02b50656" */
      ),
      cache: true
    }
  ]
...
var define_I18N_LOCALE_HASHES_default$1 = { zh: "98a20c54", en: "98a20c54" };
...
var define_I18N_LOCALE_HASHES_default = { zh: "98a20c54", en: "98a20c54" };
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D0ymNC7f.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-white/60 dark:bg-slate-900/60 transition-colors flex items-center justify-center px-6" }, _attrs))}><div class="text-center"><h1 class="text-6xl font-bold text-slate-300 dark:text-slate-600 mb-4">${ssrInterpolate(unref(statusCode))}</h1><p class="text-lg text-slate-500 dark:text-slate-400 mb-8">${ssrInterpolate(unref(message))}</p>`);
...
export { __nuxt_component_0$1 as _, useHead as a, useI18n as b, useNuxtApp as c, useRequestEvent as d, entry_default as default, useRoute as e, useRuntimeConfig as f, tryUseNuxtApp as t, useAsyncData as u };

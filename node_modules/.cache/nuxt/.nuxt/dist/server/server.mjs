...
import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, customRef, resolveComponent, onScopeDispose, createVNode, Text, Fragment, Suspense, mergeProps, withCtx, useSSRContext, createTextVNode, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/nuxt/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu, createDefu } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parsePath, parseQuery, withTrailingSlash, withoutTrailingSlash, isEqual as isEqual$1 } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/ufo/dist/index.mjs";
import { debounce } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/perfect-debounce/dist/index.mjs";
import { hash, isEqual } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/ohash/dist/index.mjs";
import { isPlainObject as isPlainObject$1 } from "@vue/shared";
import { klona } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/klona/dist/index.mjs";
import { parse as parse$1 } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import { getRequestURL as getRequestURL$1, getRequestHeader as getRequestHeader$1, getCookie as getCookie$1 } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/h3/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "C:/Users/j1829/Desktop/blog-nuxt4/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_...slug_-Ben7mzCy.js")
  },
  {
    name: "news-slug___en",
    path: "/en/news/:slug(.*)*",
  ...
  },
  {
    name: "about___zh",
    path: "/about",
    component: () => import("./_nuxt/about-A_Jyfr1D.js")
  },
  {
    name: "about___en",
    path: "/en/about",
  ...
  },
  {
    ...
    path: "/friendlink",
    component: () => import("./_nuxt/friendlink-CLQ-Dg2A.js")
  },
  {
  ...
  },
  {
    name: "news___zh",
    path: "/news",
    component: () => import("./_nuxt/index-DGtfd3rq.js")
  },
  {
    name: "news___en",
    path: "/en/news",
  ...
  },
  {
    name: "index___zh",
    path: "/",
    component: () => import("./_nuxt/index-B7gqJD8g.js")
  },
  {
    name: "index___en",
    path: "/en",
...
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-CUrxEcAB.js").then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-DYV9_cLM.js").then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-BUlwT6fU.js").then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-G7Wa3Bnh.js").then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-D-MQcqHh.js").then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-zPDBYAQT.js").then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-LzjBr3Xd.js").then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-2ot5LDvL.js").then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-Cz0vgz45.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-D0ymNC7f.js").then((m) => m.default || m))
};

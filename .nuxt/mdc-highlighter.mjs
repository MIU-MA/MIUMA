...
const bundledLangs = {
"cpp": () => import('@shikijs/langs/cpp').then(r => r.default || r),
"c++": () => import('@shikijs/langs/cpp').then(r => r.default || r),
"c": () => import('@shikijs/langs/c').then(r => r.default || r),
"python": () => import('@shikijs/langs/python').then(r => r.default || r),
"py": () => import('@shikijs/langs/python').then(r => r.default || r),
...
"xml": () => import('@shikijs/langs/xml').then(r => r.default || r),
}
const bundledThemes = {
